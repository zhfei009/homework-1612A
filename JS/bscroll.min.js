...
! function(t, i) { "object" == typeof exports && "undefined" != typeof module ? module.exports = i() : "function" == typeof define && define.amd ? define(i) : t.BScroll = i() }(this, function() {
    ...
    function U(t, i) { if (!t) throw new Error("[BScroll] " + i) }
    ...
    return st.prototype.onScroll = function() {
    ...
    }, st.prototype.resetMore = function() { this.hasMore = !0 }, st.prototype._removeTombstones = function() {
        ...
        if (U(!p(t) && !p(i), "Translate x or y is null or undefined."), p(e) && (e = this.scale), this.options.useTransform ? this.scrollerStyle[T.transform] = "translate(" + t + "px," + i + "px) scale(" + e + ")" + this.translateZ : (t = Math.round(t), i = Math.round(i), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = i + "px"), this.options.wheel)
        ...
        if (this.enabled) {
            ...
            var m = this.y === u;
            this.scrollTo(d, u, a, D.swipe), this.trigger("scroll", { x: this.x, y: this.y }), clearTimeout(this.mouseWheelEndTimer), m && (this.mouseWheelEndTimer = setTimeout(function() { i.trigger("scrollEnd", { x: i.x, y: i.y }) }, a))
        }
    ...
    }, ot.prototype._initInfinite = function() { this.options.probeType = 3, this.maxScrollY = -it, this.infiniteScroller = new st(this, this.options.infinity) }, ot.Version = "1.12.6", ot
});